...
bool AppDelegate::applicationDidFinishLaunching() {
    ...
    if(!glview) {
        ...
        glview = GLViewImpl::createWithRect("CosmicMiners", Rect(0, 0, designResolutionSize.width, designResolutionSize.height));
        //glview = GLViewImpl::createWithRect("CosmicMiners", Rect(0, 0, 230, 400));
#else
        glview = GLViewImpl::create("CosmicMiners");
#endif
...
//    director->runWithScene(scene);
    DirectorManager::getInstance()->runWithScene(DirectorManager::SCENE_MAIN);
    return true;
}

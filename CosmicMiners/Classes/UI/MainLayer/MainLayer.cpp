...
#include "../../Utils/UITools.h"
//#include "../AdsHelp.h"
USING_NS_CC;

namespace  {
    const char * kMainbg = "mainLayer/main.jpg";
    const char * kButton = "mainLayer/button.png";
    const char * kSoundAble = "mainLayer/sound_able.png";
    const char * kSoundDisable = "mainLayer/sound_disable.png";
...
bool MainLayer::init()
{
    ...
    playItem->setPosition(Vec2(bgSize.width / 2,
                               bgSize.height / 2 + playItem->getContentSize().height ));
    ...
    aboutItem->setPosition(Vec2(bgSize.width /2 ,
                                bgSize.height / 2 - aboutItem->getContentSize().height));
    ...
    _soundOffItem->setPosition(Vec2(bgSize.width /2 ,
                                bgSize.height / 4));
    ...
    _soundOnItem->setPosition(Vec2(bgSize.width /2 ,
                                bgSize.height / 4));

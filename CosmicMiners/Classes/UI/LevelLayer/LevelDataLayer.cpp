...
namespace  {
    const char* kBg = "levelLayer/level_dialog.png";
    const char* klevel_min_bg = "levelLayer/level_min_bg.png";
    const char* knumber_red = "common/number_red.png";
    const char* klevel_min_close = "levelLayer/level_min_close.png";
...
void LevelDataLayer::updateData(){
    ...
    int row = 0;
    float scale = 0.2f;
    auto size = Sprite::create(klevel_min_bg)->getContentSize();
    ...
    for(LevelData& info : levelDatas){
        ...
        auto button = Button::create(klevel_min_bg);
        ...
        if(info.isSuccess){
            auto numLabel = Label::createWithCharMap(knumber_red, 90, 90, '0');
        ...
        if(!info.isSuccess){
            auto close = Sprite::create(klevel_min_close);

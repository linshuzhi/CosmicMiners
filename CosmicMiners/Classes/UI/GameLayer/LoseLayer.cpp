...
USING_NS_CC;
namespace  {
    const char* kBg = "game/game_end_bg.png";
    const char* kButton_n = "game/game_end_button_n.png";
    const char* kButton_d = "game/game_end_button_d.png";
    const char* kLose = "game/lose.png";

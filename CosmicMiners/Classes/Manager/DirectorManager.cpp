...
#include "../UI/LevelLayer/LevelScene.h"
#include "../UI/GameLayer/GameScene.h"
#include "../UI/MainLayer/MainScene.h"
#include "cocos2d.h"
...
void DirectorManager::runWithScene(TYPE_SCENE typeScene){
    Scene* scene = nullptr;
    switch (typeScene) {
        case SCENE_MAIN:
            scene = MainScene::createScene();
